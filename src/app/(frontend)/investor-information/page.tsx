  ...
  return (
    <main className="min-h-screen pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="font-[family-name:var(--font-darwin)] text-4xl md:text-5xl font-black mb-8 text-center">
          {data.heading || 'INVESTOR INFORMATION'}
        </h1>
        <div className="bg-[#2a2e38] rounded-lg p-8 md:p-12 space-y-6">
          ...
          {data.codeOfConductPdf && typeof data.codeOfConductPdf === 'object' && data.codeOfConductPdf.url && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-[#F07922] text-black font-bold px-6 py-3 rounded hover:bg-[#d96a1a] transition-colors"
            >
